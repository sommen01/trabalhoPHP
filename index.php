...
<html>
   ...
   <body>
      ...
      <!-- JUMBOTRON -->
      <div class="jumbotron bg-dark text-light m-0 rounded-0" style="background: linear-gradient(#000028, #280000);">
      ...
      <!-- CAROUSEL -->
      <div id="myCarousel" class="carousel slide rounded-0" data-bs-ride="carousel">
         <!-- slides -->
         <div class="carousel-inner">
            <div class="carousel-item active">
               <img src="./assets/img/camaro.jpg" class="d-block w-100" >
            </div>
            <div class="carousel-item ">
               <img src="./assets/img/mustanggt.jpg" class="d-block w-100" >
            </div>
            <div class="carousel-item ">
               <img src="./assets/img/background.jpg" class="d-block w-100" >
            </div>
         </div>
         <!-- control -->
